import { getLocale, t } from "./i18n/index.js?v=1.11.3";
...
import { GalleryView } from "./gallery/GalleryView.js?v=1.11.3";
...
import { createTelegramDomain } from "./app/createTelegramDomain.js?v=1.11.3";
...
import { createEditorDomain } from "./app/createEditorDomain.js?v=1.11.3";
import { createEditorWorkspace } from "./app/createEditorWorkspace.js?v=1.11.3";
import { createEditorShell } from "./app/createEditorShell.js?v=1.11.3";
...
import { LinkingController } from "./links/LinkingController.js?v=1.11.3";
