...
import { EditorDocumentCoordinator } from "./editor/EditorDocumentCoordinator.js?v=1.7.15";
...
import { AppLifecycle } from "./app/AppLifecycle.js?v=1.7.22";
import { createTelegramDomain } from "./app/createTelegramDomain.js?v=1.7.22";
...
import { createEditorWorkspace } from "./app/createEditorWorkspace.js?v=1.7.17";
import { createEditorShell } from "./app/createEditorShell.js?v=1.7.15";
import { NetPanel } from "./app/NetPanel.js?v=1.5.9";
import { PublicationView } from "./publications/PublicationView.js?v=1.7.22";
...
const lifecycle = new AppLifecycle({
  ...
  telegramCore,
  editorPreviewStatus,
  stoppables: [notifications, telegramSettings, publicationView, linkingController, linkRelationNavigator, publicationService, projectPublicationService, ...editorShellStoppables, projectGraphReconciler]
});
let started = false;
