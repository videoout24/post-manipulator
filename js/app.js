import { getLocale, t } from "./i18n/index.js?v=1.11.2";
...
import { GalleryView } from "./gallery/GalleryView.js?v=1.11.2";
...
import { createTelegramDomain } from "./app/createTelegramDomain.js?v=1.11.2";
...
import { createEditorDomain } from "./app/createEditorDomain.js?v=1.11.2";
import { createEditorWorkspace } from "./app/createEditorWorkspace.js?v=1.11.2";
import { createEditorShell } from "./app/createEditorShell.js?v=1.11.2";
