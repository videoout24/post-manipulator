import { getLocale, t } from "./i18n/index.js?v=1.12.7";
import { EventBus } from "./core/EventBus.js?v=1.12.6";
import { Storage } from "./storage/Storage.js?v=1.8.6";
import { LayoutPreferences } from "./core/LayoutPreferences.js?v=1.7.22";
import { TelegramSettingsView } from "./telegram/TelegramSettingsView.js?v=1.12.7";
import { GalleryView } from "./gallery/GalleryView.js?v=1.12.7";
...
import { EditorDocumentCoordinator } from "./editor/EditorDocumentCoordinator.js?v=1.12.6";
...
import { createTelegramDomain } from "./app/createTelegramDomain.js?v=1.12.7";
import { createProjectDomain } from "./app/createProjectDomain.js?v=1.9.8";
import { createGalleryDomain } from "./app/createGalleryDomain.js?v=1.12.7";
import { createEditorDomain } from "./app/createEditorDomain.js?v=1.12.1";
import { createEditorWorkspace } from "./app/createEditorWorkspace.js?v=1.12.7";
import { createEditorShell } from "./app/createEditorShell.js?v=1.12.7";
...
import { comessageMutationError } from "./core/Comessage.js?v=1.12.1";
...
const operationFeedback = new OperationFeedback({ events }).start();
...
const linkingController = new LinkingController({
  ...
  draftSession,
  projectSession,
  confirmFn: message => confirmDarkDialog({
    title: t("links.linkingController.breakLinkTitle"),
    message,
    confirmLabel: t("links.linkingController.breakLinkAction"),
    danger: true
  })
}).start();
