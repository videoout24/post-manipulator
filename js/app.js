...
import { TelegramSettingsView } from "./telegram/TelegramSettingsView.js?v=1.9.1";
...
import { ProjectPublicationService } from "./project/ProjectPublicationService.js?v=1.9.1";
import { EditorDocumentCoordinator } from "./editor/EditorDocumentCoordinator.js?v=1.9.1";
...
import { createTelegramDomain } from "./app/createTelegramDomain.js?v=1.9.1";
import { createProjectDomain } from "./app/createProjectDomain.js?v=1.7.15";
import { createGalleryDomain } from "./app/createGalleryDomain.js?v=1.9.1";
import { createEditorDomain } from "./app/createEditorDomain.js?v=1.9.1";
import { createEditorWorkspace } from "./app/createEditorWorkspace.js?v=1.9.1";
import { createEditorShell } from "./app/createEditorShell.js?v=1.9.1";
import { NetPanel } from "./app/NetPanel.js?v=1.5.9";
import { PublicationView } from "./publications/PublicationView.js?v=1.9.1";
import { TelegramBackupService } from "./storage/TelegramBackupService.js?v=1.7.2";
import { AutomaticPublicationBackup } from "./storage/AutomaticPublicationBackup.js?v=1.9.1";
