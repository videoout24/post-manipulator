...
import { hasMediaSourceConflict, supportsExternalMediaUrl } from "./MediaSource.js?v=1.11.3";
import { MapLinkError, resolveMapLink } from "./MapLinkResolver.js?v=1.11.3";
