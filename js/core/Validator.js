...
import { hasMediaSourceConflict, supportsExternalMediaUrl } from "./MediaSource.js?v=1.11.2";
import { MapLinkError, resolveMapLink } from "./MapLinkResolver.js?v=1.11.2";
