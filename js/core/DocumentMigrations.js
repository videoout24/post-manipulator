...
import { normalizeStoredMediaSource } from "./MediaSource.js?v=1.11.2";
import { mapDimensions, mapOrientation, normalizeMapZoom, resolveMapLink } from "./MapLinkResolver.js?v=1.11.2";
