...
import { TelegramCore } from "../telegram/TelegramCore.js?v=1.12.3";
import { TelegramRuntime } from "../telegram/TelegramRuntime.js?v=1.12.1";
...
import { PublicationService } from "../telegram/PublicationService.js?v=1.12.6";
import { LinkRelationStore } from "../links/LinkRelationStore.js?v=1.8.6";
import { ChannelCollaborationService } from "../telegram/ChannelCollaborationService.js?v=1.12.6";
