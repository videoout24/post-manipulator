import { createDefaultPropertyRegistry } from "../core/PropertyRegistry.js?v=1.10.4";
...
import { Validator } from "../core/Validator.js?v=1.10.4";
import { registerTelegramCore } from "../blocks/registerCoreBlocks.js?v=1.9.5";
import { registerProjectBlocks } from "../blocks/registerProjectBlocks.js?v=1.7.11";
import { EditorController } from "../editor/EditorController.js?v=1.10.4";
...
import { TelegramRenderer } from "../telegram/TelegramRenderer.js?v=1.9.5";
import { Storage } from "../storage/Storage.js?v=1.8.6";
import { migrateDocumentTree } from "../core/DocumentMigrations.js?v=1.10.4";
