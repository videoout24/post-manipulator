import { createDefaultPropertyRegistry } from "../core/PropertyRegistry.js?v=1.9.1";
import { createTelegramFormattingRegistry } from "../core/FormattingRegistry.js?v=1.9.1";
...
import { Validator } from "../core/Validator.js?v=1.9.1";
import { registerTelegramCore } from "../blocks/registerCoreBlocks.js?v=1.9.1";
import { registerProjectBlocks } from "../blocks/registerProjectBlocks.js?v=1.7.11";
import { EditorController } from "../editor/EditorController.js?v=1.9.1";
import { FormulaTemplateLibrary } from "../editor/FormulaTemplateLibrary.js?v=1.5.9";
import { DraftStore } from "../editor/DraftStore.js?v=1.9.1";
import { DraftEditorSession } from "../editor/DraftEditorSession.js?v=1.5.9";
import { TelegramRenderer } from "../telegram/TelegramRenderer.js?v=1.9.1";
