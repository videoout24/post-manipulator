import { createDefaultPropertyRegistry } from "../core/PropertyRegistry.js?v=1.9.5";
...
import { Validator } from "../core/Validator.js?v=1.9.5";
...
import { EditorController } from "../editor/EditorController.js?v=1.9.5";
import { FormulaTemplateLibrary } from "../editor/FormulaTemplateLibrary.js?v=1.5.9";
import { DraftStore } from "../editor/DraftStore.js?v=1.9.5";
